...
const AppointmentCard = (user, patient, appointment) => {
  ...
  // for storing the details and biodata of user in single array
  const [detail, setDetail] = useState([]);
  const [id, setid] = useState();


  // use effect to filter the Users based on appointment data on mount
  useEffect(() => {
    const fetch = () => {
      let detailData = [];
      {
  ...
  return (
    ...
    // using shadcn table to display the data
    <Table>
